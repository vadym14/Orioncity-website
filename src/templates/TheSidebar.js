...
// actions
import { changeSider } from "../stores/reducers/publicSlice";
...
const TheSidebar = () => {
  ...
  const show = useSelector((state) => state.public.sidebarShow);

  const handleShow = (value) => {
    dispatch(changeSider(value));
  };

  return (
    <CSidebar show={show} unfoldable onShowChange={handleShow}>
